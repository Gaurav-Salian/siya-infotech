...
export const projectsData = [
  {
    media: [
      // { type: 'image', src: 'https://gaurav-salian.github.io/Test/Siyalogo.jpg' },
      { type: 'video', src: 'https://glizch.in/voucher/a.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/b.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/c.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/d.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/e.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/f.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/g.mp4' },
      { type: 'video', src: 'https://glizch.in/voucher/i.mp4' },
      // { type: 'video', src: '/i.mp4' },
      // { type: 'video', src: '/j.mp4' },
      // { type: 'video', src: '/k.mp4' },
      // { type: 'video', src: '/l.mp4' },
      // { type: 'video', src: '/m.mp4' },
      // { type: 'video', src: '/n.mp4' },
      // { type: 'video', src: '/o.mp4' },
      // { type: 'video', src: '/p.mp4' },
      // { type: 'video', src: '/q.mp4' },
      // { type: 'video', src: '/r.mp4' },
      // { type: 'video', src: '/s.mp4' },
      // { type: 'video', src: '/t.mp4' },
...
export const BtnList = [
  ...
  { label: "About Us", link: "/about", icon: "about", newTab: false },
