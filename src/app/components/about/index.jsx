    ...
    <section className='py-20 w-full'>
      <div className='grid grid-cols-12 gap-4 xs:gap-6 md:gap-8 w-full'>
        <ItemLayout className={'col-span-full lg:col-span-8 row-span-2 flex-col items-start'}>
          <h2 className='text-xl md:text-3xl text-accent text-left w-full capitalize poppins-font shiny-text'>About Siya Jewels InfoTech</h2>
          <h5 className='text-left w-full capitalize'>Upcoming Entrepreneur</h5>
          <p className='font-light text-xs sm:text-sm md:text-base'>
          Siya Jewels InfoTech is a leading digital solutions provider, specializing in web development, e-commerce platforms, AI-driven automation, jewelry CAD design, 3D rendering, social media marketing, and business automation. By seamlessly blending cutting-edge technology with creative innovation, we empower businesses to thrive in the digital landscape. Our tailored solutions are designed to elevate brands, streamline operations, and drive measurable success for clients worldwide.          </p>
        </ItemLayout>
        ...
        <ItemLayout className={'col-span-full xs:col-span-6 lg:col-span-4 text-accent'}>
          <p className='font-semibold w-full text-left text-2xl sm:text-5xl'>
            <Counter value={2.5} />k+<br></br><sub className='font-semibold text-base'>Instagram Followers</sub>
          </p>
        </ItemLayout>
