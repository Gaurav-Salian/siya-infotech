...
//       >
//         <img
//           src="https://gaurav-salian.github.io/Test/Siyalogo.jpg"
//           alt="Profile"
    ...
    <div className="relative inline-block">
      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-4">
            <div>
              <h2 className="text-lg font-semibold font-poppins shiny-text">Harish Soni</h2>
              <br />
              <span className="text-sm text-gray-400 font-poppins">Entrepreneur</span>
            </div>
            <button className="absolute top-4 right-2 text-accent" onClick={() => setIsOpen(!isOpen)}>
              ×
            </button>
          ...
          <div className="space-y-3">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 hover:text-gray-300 font-poppins"
            >
              <Github className="w-5 h-5 text-accent" />
              <span>GitHub</span>
            </a>
